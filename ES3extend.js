...
;(function() {
    ...
    if(!(!Object.getOwnPropertyNames || 'prototype' in Object.getOwnPropertyNames)) return;
    // if ES5, return

    Array.prototype.every = Array.prototype.every || function(callback, obj) {
        if(typeof callback !== 'function') throw TypeError(callback + ' is not a function');
        if(obj && typeof obj !== 'object') throw TypeError(obj + ' is not a object');
        var result;
        for(var i = 0, len = this.length; i < len; i++) {
            if(obj) result = callback.call(obj, this[i], i, this);
    ...
    Array.prototype.indexOf = Array.prototype.indexOf || function(value, start) {
        if(start && typeof start !== 'number') throw TypeError(start + ' is not a number');
        var start = start || 0,
            len = this.length;
        if(start > 0) start = Math.floor(start);
        else if(start < 0) start = Math.ceil(start) + len;
    ...
    Array.prototype.map = Array.prototype.map || function(callback, obj) {
        ...
        var array = [];
        for(var i = 0, len = this.length; i < len; i++) {
            if(obj) array[i] = callback.call(obj, this[i], i, this);
            else array[i] = callback(this[i], i, this);
        }
        return array;
    };
    ...
    Array.prototype.reduce = Array.prototype.reduce || function(callback, initial) {
        ...
        if(initial !== undefined) {
            ...
            for(var i = 0; i < len; i++) result = callback(result, this[i], i, this);
        } else {
            if(len === 0) throw TypeError('Reduce of empty array with no initial value');
            result = this[0];
            if(len === 1) return result;
            for(var i = 1; i < len; i++) result = callback(result, this[i], i, this);
        }
        return result;
    };
    ...
    Array.prototype.reduceRight = Array.prototype.reduceRight || function(callback, initial) {
        ...
        if(initial !== undefined) {
            if(len === 0) return result;
            for(var i = len - 1; i >= 0; i--) result = callback(result, this[i], i, this);
        } else {
            if(len === 0) throw TypeError('Reduce of empty array with no initial value');
            result = this[len - 1];
            if(len === 1) return result;
            for(var i = len - 2; i >= 0; i--) result = callback(result, this[i], i, this);
        }
        return result;
    };
    ...
    Object.create = Object.create || function (obj){
        var type = typeof obj;
        if (obj === null) return {};
        if (type !== 'object'  || type !== 'function') throw TypeError('Object prototype may only be an Object or null');
        function F() {};
        F.prototype = obj;
        return new F;
    };
    ...
    Object.keys = Object.keys || function(obj) {
        if(typeof obj !== 'object') throw TypeError(obj + ' is not a object');
        var result = [];
        for(var key in obj) {
